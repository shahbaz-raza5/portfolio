    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            - Familiarity with the MERN stack (MongoDB, Express.js, React.js, Node.js) and the ability to develop full-stack applications will be a plus.
          </Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            HTML, CSS, JavaScript, React, Bootstrap, Chakra, Node.js, Express, MongoDB, Troubleshooting, IT Infrastructure
          </Text>
        </View>
        <View style={styles.section}>
